...
namespace R52_M7_Class_03_Work_01.Models
{
    ...
    public class DbInitializer : DropCreateDatabaseIfModelChanges<EmployeeDbContext>
    {
        protected override void Seed(EmployeeDbContext db)
        {
            ...
            d.Employees.Add(new Employee { EmployeeName = "Dr. OZ O", JoinDate = new DateTime(2017, 8, 9) });
            d.Employees.Add(new Employee { EmployeeName = "Dr. OT S", JoinDate = new DateTime(2019, 8, 11) });
